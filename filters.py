...
TARGET_ROLE_MARKERS = {
    ...
    "analista de dados",
    "analista dados",
    "analista jr de dados",
    "analista junior de dados",
    "analista trainee de dados",
    "cientista de dados",
    "ciencia de dados",
    "cientista jr de dados",
    "cientista junior de dados",
    "cientista trainee de dados",
    "engenheiro de dados",
    "engenheira de dados",
    "engenharia de dados",
    "engenheiro jr de dados",
    "engenheiro junior de dados",
    "engenheiro trainee de dados",
    "engenheira jr de dados",
    "engenheira junior de dados",
    "engenheira trainee de dados",
    "data analyst",
    "data analytics",
    "data scientist",
    "data science",
...
def is_desired_seniority(title: str, supporting_text: str) -> bool:
    ...
    if has_seniority_block(focused_text):
        return False
    if contains_any_marker(focused_text, PLENO_MARKERS):
        return False
    return contains_any_marker(focused_text, JUNIOR_MARKERS)
